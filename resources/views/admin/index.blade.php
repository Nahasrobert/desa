                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="admin/assets/images/user/avatar-4.jpg" alt="user image"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="admin/assets/images/user/avatar-2.jpg" alt="user image"
                                                class="img-radius wid-40 align-top m-r-15">
                                            <div class="d-inline-block">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="admin/assets/images/user/avatar-3.jpg" alt="user image"
                                                class="img-radius wid-40 align-top m-r-15">
                                            <div class="d-inline-block">
                                                <h6>William Jem</h6>
                ...
                <div class="card-body">
                    <div class="row m-b-20 received-chat">
                        <div class="col-auto p-r-0">
                            <img src="admin/assets/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40">
                        </div>
                        <div class="col">
                            <div class="msg">
                    ...
                    <div class="row m-b-20 send-chat">
                        ...
                        <div class="col-auto p-l-0">
                            <img src="admin/assets/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40">
                        </div>
                    </div>
                    <div class="row m-b-20 received-chat">
                        <div class="col-auto p-r-0">
                        ...
                        <div class="col">
                            <div class="msg">
                                <p class="m-b-0">Nice to meet you!</p>
                                <img src="admin/assets/images/widget/dashborad-1.jpg" alt="">
                                <img src="admin/assets/images/widget/dashborad-3.jpg" alt="">
                            </div>
                            <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                        </div>
                    </div>
